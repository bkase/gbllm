...
///
/// Hashing is owned by higher-level crates with canonical JSON and SHA-256
/// dependencies; `gbf-hw` only defines the typed target profile contract and
/// the shared domain separator.
