...
mod tests {
    ...
    fn sample_instrs() -> Vec<Instr> {
        vec![
            ...
            Instr::LdSpFromHl,
            Instr::LdDirectFromSp { addr: 0 },
            Instr::LdHlFromSpPlus { off: 0 },
            Instr::AddA {
            ...
            Instr::Inc8 {
                dst: IncDec8Target::Reg(Reg8::D),
            },
            Instr::Dec8 {
                dst: IncDec8Target::HlIndirect,
            },
            Instr::Inc16 { dst: Reg16Data::DE },
            Instr::Dec16 { dst: Reg16Data::HL },
