#![deny(missing_docs)]
//! F-S1 First Pulse, F-S2 QAT Survives, and F-S3 TinyStories experiment orchestration.
//!
...
//! };
//! use gbf_experiments::{S1_LOG_TARGET, S2_LOG_TARGET, S3_LOG_TARGET};
//!
...
compile_error!("gbf-experiments requires at least one S1, S2, or S3 experiment feature");
